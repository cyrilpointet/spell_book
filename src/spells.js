export const spells = [
    {
        ...
        "incantation": "niveau 2 - transmutation",
        "portee": "9 mètres",
    ...
    },
    {
        ...
        "level": "niveau 2",
        "school": "abjuration",
        "incantation": "niveau 2 - abjuration",
        "portee": "9 mètres",
        "composantes": "V, S, M (un petit bout de vêtement blanc)",
        "duree": "8 heures",
        "description": "Votre sort emplit vos alliés de robustesse et de résolution. Choisissez jusqu'à trois créatures à portée. Les points de vie maximums et les points de vie actuels de chaque cible augmentent de 5 pour la durée du sort. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, les points de vie de chaque cible augmentent de 5 pour chaque niveau d'emplacement au-delà du niveau 2. <br>"
    },
    {
        "title": "Alarme",
        "level": "niveau 1",
        "school": "abjuration (rituel)",
        "incantation": "niveau 1 - abjuration (rituel)",
        "portee": "9 mètres",
    ...
    },
    {
        ...
        "level": "niveau 6",
        "school": "invocation",
        "incantation": "niveau 6 - invocation",
        "portee": "18 mètres",
        "composantes": "V, S",
        "duree": "instantanée",
    ...
    },
    {
        ...
        "level": "niveau 1",
        "school": "invocation (rituel)",
        "incantation": "niveau 1 - invocation (rituel)",
        "portee": "3 mètres",
    ...
    },
    {
        ...
        "level": "niveau 9",
        "school": "transmutation",
        "incantation": "niveau 9 - transmutation",
        "portee": "personnelle",
        "composantes": "V",
        "duree": "instantanée",
    ...
    },
    {
        ...
        "incantation": "niveau 2 - divination (rituel)",
        "portee": "personnelle",
    ...
    {
        "title": "Aura de pureté",
        "level": "niveau 4",
        "school": "abjuration",
        "incantation": "niveau 4 - abjuration",
        "portee": "personnelle (rayon de 9 mètres)",
        "composantes": "V",
        "duree": "concentration, jusqu'à 10 minutes",
    ...
    {
        "title": "Aura magique de Nystul",
        "level": "niveau 2",
        "school": "illusion",
        "incantation": "niveau 2 - illusion",
        "portee": "contact",
        "composantes": "V, S, M (un petit carré de soie)",
        "duree": "24 heures",
        "description": "Vous placez une illusion sur une créature ou un objet que vous touchez pour que les sorts de divination révèlent de fausses informations les concernant. La cible peut être une créature consentante ou un objet qui n'est pas tenu ou équipé par une autre créature. <br>Lorsque vous lancez le sort, choisissez l'un ou les deux effets suivants. L'effet reste en place pour la durée du sort. Si vous lancez ce sort sur la même créature ou le même objet tous les jours pendant 30 jours, en choisissant à chaque fois le même effet, l'illusion reste active jusqu'à ce que le sort soit dissipé. <br><strong>Fausse aura</strong>. Vous modifiez la manière dont la cible apparaît aux sorts et effets magiques, comme le sort <em><a href=\"#detection-de-la-magie\">détection   de la magie</a></em>, qui détectent les auras magiques. Vous pouvez faire en sorte qu'un objet non magique semble magique, et vice versa, ou modifier l'aura magique d'un objet pour qu'elle semble appartenir à une autre école de magie de votre choix. Lorsque vous utilisez cet effet sur un objet, vous pouvez faire en sorte que cette fausse aura soit visible pour toute créature qui tient l'objet en main. <br><strong>Masque</strong>. Vous modifiez la manière dont la cible apparaît aux sorts et effets magiques qui détectent le type d'une créature, comme le Sens divin du paladin ou le déclencheur du sort <em><a href=\"#symbole\">symbole</a></em>. Vous choisissez un type de créature, les autres sorts et effets magiques traitent la cible comme si elle était de ce type ou de cet alignement. <br>"
    },
    {
        "title": "Aura sacrée",
        "level": "niveau 8",
        "school": "abjuration",
        "incantation": "niveau 8 - abjuration",
        "portee": "personnelle",
    ...
    },
    {
        ...
        "level": "niveau 8",
        "school": "transmutation",
        "incantation": "niveau 8 - transmutation",
        "portee": "personnelle",
        "composantes": "V",
        "duree": "1 heure",
    ...
    },
    {
        ...
        "level": "niveau 1",
        "school": "transmutation",
        "incantation": "niveau 1 - transmutation",
        "portee": "contact",
    ...
    },
    {
        ...
        "duree": "concentration, jusqu'à 1 minute",
        "description": "Vous bénissez jusqu'à trois créatures de votre choix, dans la portée du sort. À chaque fois qu'une cible fait un jet d'attaque ou de sauvegarde avant la fin du sort, la cible peut lancer un d4 et ajouter le résultat au jet d'attaque ou de sauvegarde. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, vous pouvez cibler une créature supplémentaire pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Blessure",
        "level": "niveau 1",
        "school": "nécromancie",
        "incantation": "niveau 1 - nécromancie",
        "portee": "contact",
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Faites une attaque au corps à corps avec un sort contre une créature que vous pouvez toucher. En cas de réussite, la cible prend 3d10 dégâts nécrotiques. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, les dégâts augmentent de 1d10 chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Bouche magique",
        "level": "niveau 2",
        "school": "illusion (rituel)",
        "incantation": "niveau 2 - illusion (rituel)",
        "portee": "9 mètres",
    ...
    },
    {
        ...
        "duree": "instantanée",
        "description": "Une éclatante traînée lumineuse est émise de la pointe de votre doigt vers un point de votre choix dans la portée du sort, puis s'amplifie dans un rugissement grave jusqu'à éclater en flammes. Toutes les créatures situées dans une sphère de 6 mètres de rayon centrée sur le point doivent réussir un jet de sauvegarde de Dextérité sans quoi chacune d'elles subit 8d6 dégâts de feu. En cas de réussite, les dégâts sont réduits de moitié. <br>Le feu contourne les coins. Il enflamme les objets inflammables qui ne sont pas portés ou transportés. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 4 ou supérieur, les dégâts sont augmentés de 1d6 pour chaque niveau d'emplacement au-delà du niveau 3. <br>"
    },
    {
        "title": "Boule de feu à retardement",
        "level": "niveau 7",
        "school": "évocation",
        "incantation": "niveau 7 - évocation",
        "portee": "45 mètres",
        "composantes": "V, S, M (une toute petite boule de guano de chauve-souris et du souffre) ",
        "duree": "concentration, jusqu'à 1 minute",
        "description": "La pointe de votre doigt émet un rayon de lumière jaune qui se concentre sur un point dans la portée du sort et prend la forme d'une bille luisante pour la durée du sort. Lorsque le sort prend fin, soit parce que votre concentration est interrompue, soit parce que vous décidez d'y mettre fin, la bille s'ouvre dans un rugissement grave et laisse éclater des flammes qui contournent les coins. Chaque créature dans une sphère de 6 mètres de rayon centrée sur ce point doit réussir un jet de sauvegarde de Dextérité pour ne pas subir un nombre de dégâts de feu égal à la somme cumulée. En cas de réussite, les dégâts subis sont réduits de moitié. <br>Les dégâts de base sont 12d6. Si à la fin de votre tour la bille n'a pas encore explosé, les dégâts augmentent de 1d6. <br>Si la bille luisante est touchée avant la fin du sort, la créature qui la touche doit réussir un jet de sauvegarde de Dextérité, sans quoi le sort prend fin, déclenchant l'éruption de la bille en flammes. Si elle réussit, la créature peut lancer la bille jusqu'à 12 mètres. Lorsqu'elle atteint une créature ou un objet solide, le sort prend fin et la bille explose. <br>Le feu endommage les objets dans la zone et enflamme les objets inflammables qui ne sont pas portés ou transportés. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 8 ou supérieur, les dégâts de base augmentent de 1d6 pour chaque niveau d'emplacement au-delà du niveau 7. <br>"
    },
    {
        "title": "Bourrasque",
        "level": "niveau 2",
        "school": "évocation",
        "incantation": "niveau 2 - évocation",
        "portee": "personnelle (ligne de 18 mètres)",
    ...
    },
    {
        ...
        "level": "niveau 2",
        "school": "nécromancie",
        "incantation": "niveau 2 - nécromancie",
        "portee": "9 mètres",
        "composantes": "V",
        "duree": "1 minute",
        "description": "Vous pouvez aveugler ou assourdir un ennemi. Choisissez une créature que vous pouvez voir dans la portée du sort. Celle-ci doit réussir un jet de sauvegarde de Constitution sans quoi elle est soit aveuglée, soit assourdie (selon votre choix) pour la durée du sort. À la fin de chacun de ses tours, la cible effectue un jet de sauvegarde de Constitution. En cas de réussite, le sort prend fin. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, vous pouvez cibler une créature supplémentaire pour chaque niveau d'emplacement au-delà du niveau 2. <br>"
    },
    {
        "title": "Cercle de mort",
        "level": "niveau 6",
        "school": "nécromancie",
        "incantation": "niveau 6 - nécromancie",
        "portee": "45 mètres",
        "composantes": "V, S, M (de la poudre provenant d'une perle noire broyée, d'une valeur   minimum de 500 po) ",
        "duree": "instantanée",
        "description": "Une sphère d'énergie négative s'étend dans un rayon de 18 mètres à partir d'un point à portée. Chaque créature présente dans la zone doit réussir un jet de sauvegarde de Constitution. Une cible subit 8d6 dégâts nécrotiques si elle échoue son jet de sauvegarde, ou la moitié de ces dégâts si elle le réussit. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 7 ou supérieur, les dégâts augmentent de 2d6 pour chaque niveau d'emplacement au-delà du niveau 6. <br>"
    },
    {
        "title": "Cercle de pouvoir",
        "level": "niveau 5",
        "school": "abjuration",
        "incantation": "niveau 5 - abjuration",
        "portee": "personnelle (rayon de 9 mètres)",
        "composantes": "V",
        "duree": "concentration, jusqu'à 10 minutes",
    ...
    },
    {
        ...
        "level": "niveau 5",
        "school": "invocation",
        "incantation": "niveau 5 - invocation",
        "portee": "3 mètres",
    ...
    },
    {
        ...
        "school": "abjuration",
        "incantation": "niveau 8 - abjuration",
        "portee": "personnelle (sphère de 3 mètres de rayon)",
        "composantes": "V, S, M (une pincée de poudre de fer ou quelques copeaux du même métal) ",
        "duree": "concentration, jusqu'à 1 heure",
        "description": "Une sphère invisible d'antimagie d'un rayon de 3 mètres vous englobe. Cet espace est dissocié de l'énergie magique qui s'étend dans le multivers. Dans la sphère, aucun sort ne peut être incanté, les créatures convoquées disparaissent et même les objets magiques redeviennent mondains. Jusqu'à la fin du sort, la sphère reste centrée sur vous lors de vos mouvements. <br>Les sorts et les autres effets magiques, sauf ceux générés par un artéfact ou une divinité, sont réprimés à l'intérieur de la sphère et ils ne peuvent plus y pénétrer. Un emplacement utilisé pour incanter un sort réprimé est dépensé. Un effet est nul lorsqu'il est réprimé mais le temps continue de s'écouler pour le décompte de sa durée. <br><strong><em>Effets ciblés</em></strong>. Les sorts et autres effets magiques, tels que <em><a href=\"#projectile-magique\">projectile magique</a></em> ou <em><a href=\"#charme-personne\">charme-personne</a></em>, qui ciblent une créature ou un objet dans la sphère n'ont aucun effet sur la cible. <br><strong><em>Zones de magie</em></strong>. La zone d'un autre sort ou d'un effet magique, tel que <em><a href=\"#boule-de-feu\">boule de feu</a></em>, ne peut s'étendre dans la sphère. Si la sphère se superpose à une zone de magie, la partie commune est réprimée. Par exemple, les flammes créées par un <em><a href=\"#mur-de-feu\">mur de   feu</a></em> sont réprimées à l'intérieur de la sphère, créant ainsi une ouverture dans le mur, si la portion commune est suffisamment grande. <br><strong><em>Sorts</em></strong>. Tout sort ou autre effet magique actif sur une créature ou un objet dans la sphère est réprimé pendant qu'il y est. <br><strong><em>Objets magiques</em></strong>. Les propriétés et les pouvoirs des objets magiques sont réprimés dans la sphère. Par exemple, une épée longue +1 présente dans la sphère fonctionne comme une épée longue mondaine. <br>Les propriétés et les pouvoirs d'une arme magique sont réprimés s'ils sont utilisés contre une cible dans la sphère ou si l'arme est maniée par un attaquant dans la sphère. Si une arme magique ou une pièce de munition quitte entièrement la sphère (par exemple, si vous décochez une flèche magique ou si vous lancez une lance vers une cible en dehors de la sphère), la répression de la magie de l'objet cesse aussitôt qu'il la quitte. <br><strong><em>Déplacement magique</em></strong>. La téléportation et les déplacements planaires ne fonctionnent pas dans la sphère, quelle que soit l'origine ou la destination d'un tel déplacement magique. Un portail vers un autre lieu, un autre monde ou un autre plan d'existence, autant qu'une ouverture vers un espace extradimensionnel comme celui créé par le sort <em><a href=\"#corde-enchantee\">corde enchantée</a></em>, sont temporairement fermés tant qu'ils sont dans la sphère. <br><strong><em>Créatures et objets</em></strong>. Une créature ou un objet convoqué ou créé par magie disparait temporairement de la sphère. Une telle créature réapparait instantanément lorsque l'espace occupé par la créature n'est plus dans la sphère. <br><strong><em>Dissipation de la magie</em></strong>. Les sorts et les effets magiques tel que <em><a href=\"#dissipation-de-la-magie\">dissipation de la   magie</a></em> n'ont aucun effet sur la sphère. De même, les sphères créées par des sorts de <em>champ   antimagie</em> ne s'annulent pas l'une l'autre. <br>"
    },
    {
    ...
    },
    {
        ...
        "level": "niveau 7",
        "school": "invocation",
        "incantation": "niveau 7 - invocation",
        "portee": "contact",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "1 heure",
        "description": "Vous pouvez tenter de charmer un humanoïde que vous pouvez voir à portée. Ce dernier doit effectuer un jet de sauvegarde de Sagesse, avec un avantage à son jet si vous ou vos compagnons le combattez. En cas d'échec, il est charmé jusqu'à la fin de la durée du sort ou jusqu'à ce que vous ou vos compagnons cherchiez à lui nuire. La créature charmée vous considère comme un bon ami. Quand le sort prend fin, la créature sait que vous l'avez charmée. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, vous pouvez cibler une créature supplémentaire pour chaque niveau d'emplacement au-delà du niveau 1. Les créatures doivent se trouver à 9 mètres maximum les unes des autres lorsque vous les ciblez. <br>"
    },
    {
        "title": "Châtiment ardent",
        "level": "niveau 1",
        "school": "évocation",
        "incantation": "niveau 1 - évocation",
        "portee": "personnelle",
        "composantes": "V",
        "duree": "concentration, jusqu'à 1 minute",
        "description": "La prochaine fois que vous touchez une créature avec une attaque au corps à corps avec une arme pendant la durée du sort, votre arme est chauffée à blanc, et votre attaque inflige 1d6 dégâts de feu supplémentaires à la cible et l'enflamme. Au début de chacun de ses tours jusqu'à la fin du sort, la cible doit effectuer un jet de sauvegarde de Constitution. En cas d'échec, elle subit 1d6 dégâts de feu. En cas de réussite, le sort prend fin. Si la cible, ou une créature située à 1,50 mètre d'elle, utilise son action pour étouffer les flammes, ou si tout autre effet éteint les flammes (par exemple si la cible se plonge dans l'eau), le sort prend fin. <br><strong><em>Aux niveaux supérieurs</em></strong>. Si vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, les dégâts supplémentaires initiaux infligés par l'attaque augmentent de 1d6 pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Châtiment assommant",
        "level": "niveau 4",
        "school": "évocation",
        "incantation": "niveau 4 - évocation",
        "portee": "personnelle",
    ...
    {
        "title": "Châtiment de bannissement",
        "level": "niveau 5",
        "school": "abjuration",
        "incantation": "niveau 5 - abjuration",
        "portee": "personnelle",
    ...
    },
    {
        ...
        "composantes": "V",
        "duree": "concentration, jusqu'à 1 minute",
        "description": "La prochaine fois que vous touchez une créature lors d'une attaque avec une arme avant que le sort ne prenne fin, votre arme rayonne d'une lueur astrale au moment de l'impact. L'attaque inflige 2d6 dégâts radiants supplémentaires à la cible, qui devient visible si elle était invisible, et la cible émet une lumière faible dans un rayon de 1,50 mètre et ne peut devenir invisible tant que le sort persiste. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, les dégâts supplémentaires augmentent de 1d6 pour chaque niveau d'emplacement au-delà du niveau 2. <br>"
    },
    {
        "title": "Châtiment tonitruant",
        "level": "niveau 1",
        "school": "évocation",
        "incantation": "niveau 1 - évocation",
        "portee": "personnelle",
    ...
    {
        "title": "Chien de garde de Mordenkainen",
        "level": "niveau 4",
        "school": "invocation",
        "incantation": "niveau 4 - invocation",
        "portee": "9 mètres",
    ...
    },
    {
        ...
        "level": "niveau 3",
        "school": "divination",
        "incantation": "niveau 3 - divination",
        "portee": "1,5 kilomètre",
    ...
    },
    {
        ...
        "level": "niveau 8",
        "school": "nécromancie",
        "incantation": "niveau 8 - nécromancie",
        "portee": "contact",
    ...
    {
        "title": "Coffre secret de Léomund",
        "level": "niveau 4",
        "school": "invocation",
        "incantation": "niveau 4 - invocation",
        "portee": "contact",
        "composantes": "V, S, M (un coffre raffiné, dimensions : 90 cm x 60 cm x 60 x cm,   fabriqué à partir de matériaux rares d'une valeur minimum de 5 000 po, et une réplique de ce coffre en   taille TP, dans les mêmes matériaux, d'une valeur minimum de 50 po) ",
        "duree": "instantanée",
    ...
    },
    {
        ...
        "level": "niveau 1",
        "school": "divination (rituel)",
        "incantation": "niveau 1 - divination (rituel)",
        "portee": "personnelle",
        "composantes": "V, S",
        "duree": "10 minutes",
    ...
    },
    {
        ...
        "level": "niveau 4",
        "school": "enchantement",
        "incantation": "niveau 4 - enchantement",
        "portee": "9 mètres",
        "composantes": "V, S",
        "duree": "concentration, jusqu'à 1 minute",
    ...
    },
    {
        ...
        "school": "évocation",
        "incantation": "niveau 5 - évocation",
        "portee": "personnelle (cône de 18 mètres)",
        "composantes": "V, S, M (un petit cône de cristal ou de verre)",
        "duree": "instantanée",
        "description": "Un souffle d'air froid est propulsé de vos mains. Chaque créature se trouvant dans les 18 mètres du cône doit effectuer un jet de sauvegarde de Constitution. Une créature subit 8d8 dégâts de froid en cas d'échec, ou la moitié de ces dégâts en cas de réussite. Une créature tuée par le sort devient une statue de glace jusqu'à son dégel. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 6 ou supérieur, les dégâts augmentent de 1d8 pour chaque niveau d'emplacement au-delà du niveau 5. <br>"
    },
    {
        "title": "Confusion",
        "level": "niveau 4",
        ...
        "duree": "concentration, jusqu'à 1 minute",
        "description": "Ce sort assaille et tord les esprits des créatures, générant des illusions et provoquant des actions incontrôlées. Chaque créature dans une sphère de 3 mètres de rayon centrée sur un point choisi dans la portée du sort doit réussir un jet de sauvegarde de Sagesse sans quoi elle sera affectée par le sort. <br>Une cible affectée ne peut réagir et elle doit lancer 1d10 au début de chacun de ses tours pour déterminer son comportement pour ce tour. <br> <table>   <tbody>   <tr>  <th class=\"center\">d10</th>  <th>Comportement</th>   </tr>   <tr>  <td class=\"center\">1</td>  <td>La créature emploie tout son mouvement pour se déplacer de façon aléatoire. Pour déterminer la  direction, lancez 1d8 et assignez une direction à chaque face. La créature ne prend pas d'action  pour ce tour.  </td>   </tr>   <tr>  <td class=\"center\">2-6</td>  <td>La créature ne se déplace pas et elle ne prend pas d'action pour ce tour.</td>   </tr>   <tr>  <td class=\"center\">7-8</td>  <td>La créature prend son action pour faire une attaque au corps à corps contre une créature à sa  portée, déterminée de façon aléatoire. Si aucune créature n'est à sa portée, la créature ne fait  rien pour ce tour.  </td>   </tr>   <tr>  <td class=\"center\">9-10</td>  <td>La créature peut agir et se déplacer normalement.</td>   </tr>   </tbody> </table> <br>À la fin de chacun de ses tours, une créature affectée peut faire un jet de sauvegarde de Sagesse. En cas de réussite, l'effet du sort prend fin pour cette cible. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 5 ou supérieur, le rayon de la sphère augmente de 1,50 mètre pour chaque niveau d'emplacement au-delà du niveau 4. <br>"
    },
    {
        "title": "Contact avec un autre plan",
        "level": "niveau 5",
        "school": "divination (rituel)",
        "incantation": "niveau 5 - divination (rituel)",
        "portee": "personnelle",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Vous libérez une infection virulente sur une créature que vous voyez dans la portée du sort. La cible doit réussir un jet de sauvegarde de Constitution sans quoi elle subit 14d6 dégâts nécrotiques. Si elle réussit, les dégâts sont réduits de moitié. Les dégâts ne peuvent réduire les points de vie de la cible sous 1. Si la cible échoue le jet de sauvegarde, ses points de vie maximums sont amputés pour 1 heure de la même quantité de dégâts nécrotiques subis. Tout effet qui enraye la maladie permet aux points de vie maximums de la créature de retrouver leur valeur normale avant la fin de l'effet du sort. <br>"
    },
    {
        "title": "Contrat",
        "level": "niveau 5",
    ...
    },
    {
        ...
        "school": "transmutation",
        "incantation": "niveau 8 - transmutation",
        "portee": "personnelle (rayon de 7,5 kilomètres)",
    ...
    },
    {
        ...
        "duree": "8 heures",
        "description": "Vous plantez quatre pièces de munition non magiques (flèches ou carreaux d'arbalète) dans le sol à portée et y apposez votre magie pour qu'elles protègent la zone. Jusqu'à la fin du sort, à chaque fois qu'une autre créature que vous arrive à 9 mètres ou moins des munitions, pour la première fois du tour, ou termine son tour dans ces 9 mètres, une pièce de munition s'envole pour la frapper. La créature doit réussir un jet de sauvegarde de Dextérité sous peine de subir 1d6 dégâts perforants. La pièce de munition est ensuite détruite. La sort se termine lorsqu'il ne reste plus de munition. <br>Lorsque vous lancez ce sort, vous pouvez désigner toutes les créatures que vous souhaitez pour que le sort les ignore. <br><strong><em>Aux niveaux supérieurs</em></strong>. Si vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, le nombre de munitions qui peuvent être affectées augmente de deux pour chaque niveau d'emplacement au-delà du niveau 2. <br>"
    },
    {
        "title": "Couleurs dansantes",
        "level": "niveau 1",
        "school": "illusion",
        "incantation": "niveau 1 - illusion",
        "portee": "personnelle (cône de 4,50 mètres)",
        "composantes": "V, S, M (une pincée de poudre ou de sable de couleur rouge, jaune et   bleu) ",
        "duree": "1 round",
        "description": "Un assortiment éblouissant de faisceaux lumineux et colorés fait éruption de votre main. Lancez 6d10. Cette valeur représente le nombre maximal de points de vie des créatures que vous pouvez affecter avec ce sort. Les créatures dans un cône de 4,50 mètres dont vous êtes l'origine sont affectées selon l'ordre croissant de leurs points de vie (en ignorant les créatures inconscientes et celles qui ne peuvent pas voir). <br>En partant de la créature avec le plus petit nombre de points de vie, chaque créature affectée par ce sort est aveuglée jusqu'à la fin de votre prochain tour. Retirez les points de vie de chaque créature avant de passer à la prochaine créature avec le plus petit nombre de points de vie. Les points de vie d'une créature doivent être égaux ou inférieurs au total pour que cette créature soit affectée. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, ajoutez 2d10 au lancer initial pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Coup au but",
        "level": "niveau 0",
    ...
    {
        "title": "Danse irrésistible d'Otto",
        "level": "niveau 6",
        "school": "enchantement",
        "incantation": "niveau 6 - enchantement",
        "portee": "9 mètres",
        "composantes": "V",
        "duree": "concentration, jusqu'à 1 minute",
    ...
    },
    {
        ...
        "level": "niveau 8",
        "school": "invocation",
        "incantation": "niveau 8 - invocation",
        "portee": "18 mètres",
        "composantes": "S",
        "duree": "1 heure",
    ...
    },
    {
        ...
        "level": "niveau 6",
        "school": "transmutation",
        "incantation": "niveau 6 - transmutation",
        "portee": "18 mètres",
        "composantes": "V, S, M (de la magnétite et une pincée de poussière)",
        "duree": "instantanée",
        "description": "Un mince faisceau de lumière verte surgit de la pointe de votre doigt vers une cible visible dans la portée du sort. La cible peut être une créature, un objet ou une création de force magique, comme un mur façonné par <em><a href=\"#mur-de-force\">mur de force</a></em>. <br>Une créature ciblée par ce sort doit réussir un jet de sauvegarde de Dextérité sans quoi elle subit 10d6 + 40 dégâts de force. La cible est désintégrée si ces dommages la laissent à 0 point de vie. <br>Une créature désintégrée et tout ce qu'elle porte et transporte, à l'exception des objets magiques, sont réduits à l'état de poussière. La créature peut être ramenée à la vie uniquement avec les sorts <em><a href=\"#resurrection-supreme\">résurrection suprême</a></em> et <em><a href=\"#souhait\">souhait</a></em>. <br>Le sort désintègre automatiquement un objet non magique de taille G ou plus petit, ou une création de force magique. Si la cible est un objet ou une création de force de taille TG ou supérieure, le sort désintègre une portion équivalente à un cube de 3 mètres d'arête. Un objet magique n'est pas affecté par ce sort. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 7 ou supérieur, les dégâts sont augmentés de 3d6 pour chaque niveau d'emplacement au-delà du niveau 6. <br>"
    },
    {
    ...
    },
    {
        ...
        "level": "niveau 2",
        "school": "divination",
        "incantation": "niveau 2 - divination",
        "portee": "personnelle",
    ...
    },
    {
        ...
        "level": "niveau 1",
        "school": "divination",
        "incantation": "niveau 1 - divination",
        "portee": "personnelle",
        "composantes": "V, S",
        "duree": "concentration, jusqu'à 10 minutes",
    ...
    {
        "title": "Disque flottant de Tenser",
        "level": "niveau 1",
        "school": "invocation (rituel)",
        "incantation": "niveau 1 - invocation (rituel)",
        "portee": "9 mètres",
    ...
    },
    {
        ...
        "level": "niveau 7",
        "school": "transmutation",
        "incantation": "niveau 7 - transmutation",
        "portee": "contact",
        "composantes": "V, S, M (une poudre composée de poussières de diamant, d'émeraude, de   rubis, et de saphir d'une valeur minimum de 5 000 po, que le sort consomme) ",
        "duree": "jusqu'à dissipation",
    ...
    },
    {
        ...
        "level": "niveau 4",
        "school": "divination (rituel)",
        "incantation": "niveau 4 - divination (rituel)",
        "portee": "personnelle",
    ...
    },
    {
        ...
        "level": "niveau 0",
        "school": "transmutation",
        "incantation": "niveau 0 - transmutation",
        "portee": "9 mètres",
        "composantes": "V, S",
        "duree": "instantanée",
    ...
    },
    {
        ...
        "school": "évocation",
        "incantation": "niveau 3 - évocation",
        "portee": "personnelle (ligne de 30 mètres)",
        "composantes": "V, S, M (un morceau de fourrure et un bâtonnet d'ambre, de cristal ou de   verre) ",
        "duree": "instantanée",
        "description": "Un rayon de foudre formant une ligne d'une longueur de 30 mètres et d'une largeur de 1,50 mètre jaillit de vous dans la direction de votre choix. Toute créature sur la ligne doit réussir un jet de sauvegarde de Dextérité sans quoi elle subit 8d6 dégâts de foudre. Si elle réussit, les dégâts sont réduits de moitié. <br>L'éclair enflamme les objets inflammables qui ne sont pas portés ou transportés. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 4 ou supérieur, les dégâts augmentent de 1d6 pour chaque niveau d'emplacement au-delà du niveau 3. <br>"
    },
    {
        "title": "Éclair de sorcière",
        "level": "niveau 1",
        "school": "évocation",
        "incantation": "niveau 1 - évocation",
        "portee": "9 mètres",
        ...
        "duree": "concentration, jusqu'à 1 minute",
        "description": "Un rayon d'énergie bleu crépitante est projeté sur une créature à portée, formant un arc électrique continu entre la cible et vous. Effectuez une attaque à distance avec un sort contre la créature. Si vous touchez, la cible subit 1d12 dégâts de foudre, et à chacun de vos tours, pour la durée du sort, vous pouvez utiliser votre action pour infliger automatiquement 1d12 dégâts de foudre à la cible. Le sort se termine si vous utilisez votre action pour faire autre chose qu'infliger ces dégâts de foudre, si la cible se retrouve hors de la portée du sort, ou si elle obtient un abri total contre vous. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, les dégâts initiaux sont augmentés de 1d12 pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Éclair traçant",
        "level": "niveau 1",
        "school": "évocation",
        "incantation": "niveau 1 - évocation",
        "portee": "36 mètres",
        "composantes": "V, S",
        "duree": "1 round",
        "description": "Un éclair silencieux fonce sur une créature de votre choix dans la portée du sort. Faites une attaque à distance avec un sort contre la cible. Si elle réussit, la cible subit 4d6 dégâts radiants et le prochain jet d'attaque effectué contre cette cible avant la fin du votre prochain tour bénéficie d'un avantage grâce à la lumière faible mystique qui illumine alors la cible. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, les dégâts infligés augmentent de 1d6 pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Éclat du soleil",
        "level": "niveau 8",
        "school": "évocation",
        "incantation": "niveau 8 - évocation",
        "portee": "45 mètres",
    ...
    },
    {
        ...
        "level": "niveau 9",
        "school": "abjuration",
        "incantation": "niveau 9 - abjuration",
        "portee": "9 mètres",
    ...
    {
        "title": "Faim inextinguible de Hadar",
        "level": "niveau 3",
        "school": "invocation",
        "incantation": "niveau 3 - invocation",
        "portee": "45 mètres",
    ...
    },
    {
        ...
        "portee": "9 mètres",
        "composantes": "V, S",
        "duree": "concentration, jusqu'à 24 heures",
    ...
    },
    {
        ...
        "duree": "instantanée",
        "description": "Un fort bruit résonnant, douloureusement intense, retentit d'un point de votre choix dans la portée du sort. Chaque créature présente dans une sphère d'un rayon de 3 mètres centrée sur ce point doit réussir un jet de sauvegarde de Constitution sans quoi elle subit 3d8 dégâts de tonnerre. Si elle réussit, les dégâts sont réduits de moitié. Une créature constituée de matériau inorganique, comme la pierre, le cristal ou le métal, fait son jet de sauvegarde avec un désavantage. <br>Un objet non magique qui n'est pas porté ou transporté subit aussi les dégâts s'il est dans la zone du sort. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, les dégâts du sort augmentent de 1d8 pour chaque niveau d'emplacement au-delà du niveau 2. <br>"
    },
    {
        "title": "Frappe piégeante",
        "level": "niveau 1",
        "school": "invocation",
        "incantation": "niveau 1 - invocation",
        "portee": "personnelle",
        "composantes": "V",
        "duree": "concentration, jusqu'à 1 minute",
        "description": "La prochaine fois que vous touchez une créature avec une attaque avec une arme avant que ce sort ne prenne fin, une masse tortueuse de lianes épineuses apparaît au point d'impact, et la cible doit réussir un jet de sauvegarde de Force sous peine d'être entravée par ces lianes magiques jusqu'à ce que le sort prenne fin. Une créature de taille G ou supérieure a un avantage à son jet de sauvegarde. Si la cible réussit son jet de sauvegarde, les lianes se flétrissent et tombent. <br>Tant qu'elle est entravée par ce sort, la cible subit 1d6 dégâts perforants au début de chacun de ses tours. Une créature entravée par ces lianes, ou une autre créature capable de la toucher, peut utiliser son action pour effectuer un jet de Force contre le DD de sauvegarde de votre sort. En cas de réussite, la cible est libérée. <br><strong><em>Aux niveaux supérieurs</em></strong>. Si vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, les dégâts augmentent de 1d6 pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Fusion dans la pierre",
        "level": "niveau 3",
        "school": "transmutation (rituel)",
        "incantation": "niveau 3 - transmutation (rituel)",
        "portee": "contact",
        "composantes": "V, S",
        "duree": "8 heures",
    ...
    },
    {
        ...
        "duree": "1 heure",
        "description": "Vous touchez une créature. La vitesse de la cible augmente de 3 mètres jusqu'à la fin du sort. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, vous pouvez cibler une créature supplémentaire pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Grêle d'épines",
        "level": "niveau 1",
        "school": "invocation",
        "incantation": "niveau 1 - invocation",
        "portee": "personnelle",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Choisissez une créature que vous voyez dans la portée du sort. Une décharge d'énergie positive engouffre la créature lui permettant de récupérer 70 points de vie. Ce sort met aussi un terme à un aveuglement, une surdité et toutes autres maladies accablant la cible. Ce sort n'a pas d'effet sur les créatures artificielles et les morts-vivants. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 7 ou supérieur, la quantité de points de vie récupérés est augmentée de 10 pour chaque niveau d'emplacement au-delà du niveau 6. <br>"
    },
    {
        "title": "Guérison de groupe",
        "level": "niveau 9",
        "school": "évocation",
        "incantation": "niveau 9 - évocation",
        "portee": "18 mètres",
        "composantes": "V, S",
        "duree": "instantanée",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "concentration, jusqu'à 1 minute",
        "description": "Une créature consentante que vous touchez est submergée par le courage. Jusqu'à la fin du sort, la créature est immunisée contre la condition effrayé et gagne un nombre de points de vie temporaires égal au modificateur de votre caractéristique d'incantation, et ce au début de chacun de ses tours. Lorsque le sort prend fin, la cible perd tous les points de vie temporaires qu'il lui restait et qui lui avaient été conférés par ce sort. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, vous pouvez cibler une créature supplémentaire pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
    ...
    },
    {
        ...
        "duree": "concentration, jusqu'à 1 minute",
        "description": "Choisissez une créature que vous pouvez voir et à portée. La cible doit réussir un jet de sauvegarde de Sagesse ou être paralysée pour la durée du sort. Ce sort n'a aucun effet contre les morts-vivants. À la fin de chacun de ses tours, la cible peut effectuer un nouveau jet de sauvegarde de Sagesse. En cas de réussite, le sort prend fin pour la créature. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 6 ou supérieur, vous pouvez cibler une créature supplémentaire pour chaque niveau d'emplacement au-delà du niveau 5. Les créatures doivent toutes être à 9 mètres les unes des autres quand vous les ciblez. <br>"
    },
    {
        ...
        "duree": "concentration, jusqu'à 1 minute",
        "description": "Choisissez un humanoïde visible dans la portée du sort. La cible doit réussir un jet de sauvegarde de Sagesse sans quoi elle est paralysée pour la durée du sort. À la fin de chacun de ses tours, la cible peut faire un autre jet de sauvegarde de Sagesse. Si elle réussit, le sort prend fin. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, vous pouvez cibler un humanoïde supplémentaire pour chaque niveau d'emplacement au-delà du niveau 2. Les humanoïdes doivent être situés à 9 mètres ou moins les uns des autres. <br>"
    },
    {
        "title": "Injonction",
        "level": "niveau 1",
        ...
        "composantes": "V",
        "duree": "1 round",
        "description": "Vous donnez un ordre d'un mot à une créature dans la portée du sort et que vous pouvez voir. La cible doit réussir un jet de sauvegarde de Sagesse ou suivre l'ordre lors de son prochain tour. Le sort n'a aucun effet si la cible est un mort-vivant, si elle ne comprend pas la langue, ou si votre ordre est directement nocif pour elle. <br>Des injonctions typiques et leurs effets suivent. Vous pouvez émettre un ordre autre que ceux décrits ici. Si vous le faites, le MD détermine comment la cible se comporte. Si la cible est empêchée de suivre votre ordre, le sort prend fin. <br><strong><em>Approche</em></strong>. La cible se déplace vers vous par le chemin le plus court et le plus direct, terminant son tour si elle arrive à 1,50 mètre ou moins de vous. <br><strong><em>Lâche</em></strong>. La cible lâche tout ce qu'elle tient et termine alors à son tour. <br><strong><em>Fuis</em></strong>. La cible s'éloigne de vous le plus rapidement possible. <br><strong><em>Tombe</em></strong>. La cible tombe au sol et termine alors à son tour. <br><strong><em>Halte</em></strong>. La cible ne bouge plus et n'entreprend aucune action. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, vous pouvez affecter une créature supplémentaire pour chaque niveau d'emplacement au-delà du niveau 1. Les créatures que vous ciblez doivent toutes être dans un rayon de 9 mètres. <br>"
    },
    {
        "title": "Insecte géant",
        "level": "niveau 4",
        ...
        "composantes": "V, S",
        "duree": "concentration, jusqu'à 10 minutes",
        "description": "Vous transformez jusqu'à dix mille-pattes, trois araignées, cinq guêpes, ou un scorpion, à portée, en version géante de leur forme naturelle pour toute la durée du sort. Un mille-pattes devient un <a href=\"#monstre-mille-pattes-geant\">mille-pattes géant</a>, une araignée devient une <a href=\"#monstre-araignee-geante\">araignée   géante</a>, une guêpe devient une <a href=\"#monstre-guepe-geante\">guêpe   géante</a>, et un scorpion devient un <a href=\"#monstre-scorpion-geant\">scorpion géant</a>. <br>Chaque créature obéit à vos commandes verbales et en combat, à chaque round, elles agissent à votre tour. Le MD possède les statistiques de ces créatures et détermine leurs actions et déplacements. <br>Une créature reste à se taille géante pour la durée du sort, jusqu'à ce qu'elle tombe à 0 point de vie, ou jusqu'à ce que vous utilisiez une action pour annuler l'effet sur elle. <br>Le MD peut vous autoriser à choisir des cibles différentes de celles présentées ci-dessus. Par exemple, si vous transformez une abeille, sa version géante pourrait avoir les mêmes statistiques que la guêpe géante. <br>"
    },
    {
        "title": "Interdiction",
        "level": "niveau 6",
        "school": "abjuration (rituel)",
        "incantation": "niveau 6 - abjuration (rituel)",
        "portee": "contact",
    ...
    {
        "title": "Invocation d'êtres des bois",
        "level": "niveau 4",
        "school": "invocation",
        "incantation": "niveau 4 - invocation",
        "portee": "18 mètres",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "concentration, jusqu'à 1 heure",
        "description": "Vous invoquez un céleste de FP 4 ou inférieur, qui apparaît dans un espace inoccupé que vous pouvez voir et à portée. Le céleste disparaît lorsqu'il tombe à 0 point de vie ou lorsque le sort prend fin. <br>Le céleste a une attitude amicale envers vous et vos compagnons pour la durée du sort. Lancez l'initiative pour le céleste ; il a ses propres tours de jeu. Il obéit aux commandes verbales que vous lui transmettez (aucune action n'est requise de votre part), tant qu'elles ne sont pas en contradiction avec son alignement. Si vous ne lui donnez aucun ordre, le céleste ne fait que se défendre contre les créatures qui lui sont hostiles. Le MD possède les statistiques du céleste. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 9, vous invoquez un céleste de FP 5 ou inférieur. <br>"
    },
    {
        "title": "Invocation de fée",
        "level": "niveau 6",
        "school": "invocation",
        "incantation": "niveau 6 - invocation",
        "portee": "27 mètres",
        "composantes": "V, S",
        "duree": "concentration, jusqu'à 1 heure",
        "description": "Vous invoquez une créature de type fée de FP 6 ou inférieur, ou un esprit féérique qui prend la forme d'une bête de FP 6 ou inférieur. Elle apparaît dans un espace inoccupé que vous pouvez voir et à portée. La fée disparaît lorsqu'elle tombe à 0 point de vie ou lorsque le sort prend fin. <br>La fée a une attitude amicale envers vous et vos compagnons pour la durée du sort. Lancez l'initiative pour la fée ; elle a ses propres tours de jeu. Elle obéit aux commandes verbales que vous lui transmettez (aucune action n'est requise de votre part), tant qu'elles ne sont pas en contradiction avec son alignement. Si vous ne lui donnez aucun ordre, la fée ne fait que se défendre contre les créatures qui lui sont hostiles. <br>Si votre concentration est interrompue, la fée ne disparaît pas. Au lieu de cela, vous perdez le contrôle de la créature, elle devient hostile envers vous et vos compagnons, et peut vous attaquer. Vous ne pouvez pas renvoyer une fée que vous ne contrôlez plus. Elle disparaît 1 heure après que vous l'ayez invoquée. Le MD possède les statistiques de la fée. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 7 ou supérieur, le FP augmente de 1 pour chaque niveau d'emplacement au-delà du niveau 6. <br>"
    },
    {
        "title": "Invocation de tir de barrage",
        "level": "niveau 3",
        "school": "invocation",
        "incantation": "niveau 3 - invocation",
        "portee": "personnelle (cône de 18 mètres)",
        ...
        "duree": "instantanée",
        "description": "Vous lancez une arme non magique ou tirez une munition non magique en l'air pour créer un cône d'armes identiques propulsées vers l'avant, qui disparaissent une fois l'autre course terminée. Chaque créature dans un cône de 18 mètres doit réussir un jet de sauvegarde de Dextérité. Une créature subit 3d8 dégâts en cas d'échec, ou la moitié de ces dégâts en cas de réussite. Le type de dégâts est le même que celui de l'arme ou de la munition utilisée comme composante. <br>"
    },
    {
        "title": "Invocation de volée de projectiles",
        "level": "niveau 5",
        "school": "invocation",
        "incantation": "niveau 5 - invocation",
        "portee": "45 mètres",
    ...
    },
    {
        ...
        "duree": "concentration, jusqu'à 10 minutes",
        "description": "Vous créez une lame ardente dans votre main libre. La lame est similaire en taille et en forme à un cimeterre, et reste jusqu'à ce que le sort prenne fin. Si vous lâchez l'arme, elle disparaît, mais vous pouvez la réinvoquer par une action bonus. <br>Vous pouvez utiliser votre action pour faire une attaque au corps à corps avec un sort avec la lame ardente. Si le coup touche, la cible subit 3d6 dégâts de feu. <br>La lame enflammée émet une lumière vive dans un rayon de 3 mètres et une lumière faible sur 3 mètres supplémentaires. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 4 ou supérieur, les dégâts augmentent de 1d6 tous les 2 niveaux d'emplacement au-dessus du niveau 2. <br>"
    },
    {
        "title": "Langues",
        "level": "niveau 3",
    ...
    },
    {
        ...
        "level": "niveau 5",
        "school": "divination",
        "incantation": "niveau 5 - divination",
        "portee": "personnelle",
    ...
    {
        "title": "Lien télépathique de Rary",
        "level": "niveau 5",
        "school": "divination (rituel)",
        "incantation": "niveau 5 - divination (rituel)",
        "portee": "9 mètres",
    ...
    {
        "title": "Localisation d'animaux ou de plantes",
        "level": "niveau 2",
        "school": "divination (rituel)",
        "incantation": "niveau 2 - divination (rituel)",
        "portee": "personnelle",
    ...
    },
    {
        "title": "Mort simulée",
        "level": "niveau 3",
        "school": "nécromancie (rituel)",
        "incantation": "niveau 3 - nécromancie (rituel)",
        "portee": "contact",
    ...
    },
    {
        ...
        "composantes": "V",
        "duree": "instantanée",
        "description": "Une créature visible de votre choix récupère des points de vie à hauteur de 1d4 + le modificateur de votre caractéristique d'incantation. Ce sort n'a pas d'effet sur les morts-vivants et les créatures artificielles. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, les points de vie récupérés augmentent de 1d4 pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        ...
        "composantes": "V",
        "duree": "instantanée",
        "description": "À mesure que vous évoquez des paroles de rétablissement, jusqu'à six créatures visibles de votre choix récupèrent un nombre de points de vie égal à 1d4 + le modificateur de votre caractéristique d'incantation. Ce sort n'a pas d'effet sur les morts-vivants et les créatures artificielles. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 4 ou supérieur, les points de vie récupérés augmentent de 1d4 pour chaque niveau d'emplacement au-delà du niveau 3. <br>"
    },
    {
    ...
    {
        "title": "Mot de pouvoir guérisseur",
        "level": "niveau 9",
        "school": "évocation",
        "incantation": "niveau 9 - évocation",
        "portee": "contact",
    ...
    },
    {
        ...
        "duree": "concentration, jusqu'à 10 minutes",
        "description": "Vous créez un mur résistant mais souple de broussailles enchevêtrées et hérissées d'aiguilles acérées. Le mur apparaît sur une surface solide à portée et reste en place pendant toute la durée du sort. Vous pouvez choisir de créer un mur long de 18 mètres, haut de 3 mètres et épais de 1,50 mètre, ou bien un mur circulaire de 6 mètres de diamètre, d'une hauteur maximale de 6 mètres et de 1,50 mètre d'épaisseur. Le mur bloque la vue. <br>Lorsque le mur apparaît, chaque créature se trouvant dans la zone doit effectuer un jet de sauvegarde de Dextérité. En cas d'échec au jet de sauvegarde, une créature subit 7d8 dégâts perforants, ou la moitié de ces dégâts en cas de réussite. <br>Une créature peut se déplacer au travers du mur, quoique lentement et difficilement. Pour chaque mètre de progression la créature doit dépenser 4 mètres de déplacement. Par ailleurs, la première fois du tour qu'une créature entre dans le mur ou y termine son tour, la créature doit effectuer un jet de sauvegarde de Dextérité. Elle subit 7d8 dégâts tranchants en cas d'échec, ou la moitié de ces dégâts en cas de réussite. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 7 ou supérieur, les deux types de dégâts sont augmentés de 1d8 pour chaque niveau d'emplacement au-delà du niveau 6. <br>"
    },
    {
        "title": "Mur de feu",
        "level": "niveau 4",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "concentration, jusqu'à 1 heure",
        "description": "Vous créez une sphère de brouillard de 6 mètres de rayon centrée sur un point dans la portée du sort. La sphère s'étend au-delà des coins et la visibilité dans la zone est nulle. Elle persiste pour la durée du sort ou jusqu'à ce qu'un vent de force modérée ou plus (au moins 15 km/h) la dissipe. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, le rayon de la sphère augmente de 6 mètres pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Non-détection",
        "level": "niveau 3",
    ...
    },
    {
        ...
        "duree": "concentration, jusqu'à 1 minute",
        "description": "Vous emplissez l'espace de dagues tournoyantes dans un cube de 1,50 mètre d'arête, centré sur un point dans la portée du sort. Une créature subit 4d4 dégâts tranchants lorsqu'elle pénètre dans la zone du sort pour la première fois ou si elle y débute son tour. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, les dégâts augmentent de 2d4 pour chaque niveau d'emplacement au-delà du niveau 2. <br>"
    },
    {
    ...
    },
    {
        ...
        "school": "évocation",
        "incantation": "niveau 1 - évocation",
        "portee": "personnelle (cube de 4,50 mètres d'arête)",
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Une vague de force de tonnerre émane de vous. Toute créature se trouvant dans un cube de 4,50 mètres d'arête prenant origine à partir de vous-même doit faire un jet de sauvegarde de Constitution. En cas d'échec, la créature prend 2d8 dégâts de tonnerre et est repoussée de 3 mètres de vous. En cas de réussite, la créature prend seulement la moitié des dégâts et n'est pas repoussée. <br>En outre, les objets non fixés qui se trouvent entièrement dans la zone d'effet sont automatiquement repoussés de 3 mètres par l'effet du sort, et le sort émet un coup de tonnerre audible jusqu'à 90 mètres. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, les dégâts augmentent de 1d8 pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Orbe chromatique",
        "level": "niveau 1",
        "school": "évocation",
        "incantation": "niveau 1 - évocation",
        "portee": "27 mètres",
    ...
    },
    {
        ...
        "composantes": "V",
        "duree": "instantanée",
        "description": "Vous prononcez une parole divine, emplie de la puissance qui a façonné le monde à l'aube de la création. Choisissez autant de créatures que vous le souhaitez parmi celles que vous voyez, dans la portée du sort. Chaque créature qui vous entend doit réussir un jet de sauvegarde de Charisme, sans quoi elle subit un effet selon la valeur actuelle de ses points de vie. <br>• 50 pv ou moins : assourdie pendant 1 minute <br>• 40 pv ou moins : assourdie et aveuglée pendant 10 minutes <br>• 30 pv ou moins : aveuglée, assourdie et étourdie pendant 1 heure <br>• 20 pv ou moins : tuée sur le coup <br>Indépendamment de ses points de vie actuels, un céleste, un élémentaire, une fée ou un fiélon qui échoue son jet est retourné à son plan d'origine (s'il n'y est pas déjà) et il ne peut revenir sur votre plan pendant 24 heures, peu importe le moyen, à l'exception du sort <em><a href=\"#souhait\">souhait</a></em>. <br>"
    },
    {
        "title": "Pas brumeux",
        "level": "niveau 2",
    ...
    {
        "title": "Petite hutte de Léomund",
        "level": "niveau 3",
        "school": "évocation (rituel)",
        "incantation": "niveau 3 - évocation (rituel)",
        "portee": "personnelle (hémisphère de 3 mètres de rayon)",
    ...
    },
    {
        ...
        "level": "niveau 9",
        "school": "invocation",
        "incantation": "niveau 9 - invocation",
        "portee": "18 mètres",
    ...
    },
    {
        ...
        "level": "niveau 9",
        "school": "divination",
        "incantation": "niveau 9 - divination",
        "portee": "contact",
    ...
    },
    {
        ...
        "level": "niveau 2",
        "school": "nécromancie (rituel)",
        "incantation": "niveau 2 - nécromancie (rituel)",
        "portee": "contact",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Vous créez trois fléchettes de force magique d'un bleu lumineux. Chaque fléchette atteint une créature de votre choix que vous pouvez voir et dans la limite de portée du sort. Chaque projectile inflige 1d4 + 1 dégâts de force à sa cible. Les fléchettes frappent simultanément, et peuvent frapper une ou plusieurs créatures. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, il crée une fléchette additionnelle pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Projection astrale",
        "level": "niveau 9",
        "school": "nécromancie",
        "incantation": "niveau 9 - nécromancie",
        "portee": "3 mètres",
    ...
    {
        "title": "Protection contre les armes",
        "level": "niveau 0",
        "school": "abjuration",
        "incantation": "niveau 0 - abjuration",
        "portee": "personnelle",
        "composantes": "V, S",
        "duree": "1 round",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Vous générez trois rayons de feu et vous les projetez vers des cibles dans la portée du sort. Vous pouvez les projeter sur une ou plusieurs cibles. <br>Effectuez une attaque à distance avec un sort pour chaque rayon. Si elle touche, la cible subit 2d6 dégâts de feu. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, vous générez un rayon supplémentaire pour chaque niveau d'emplacement au-delà du niveau 2. <br>"
    },
    {
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Vous pointez votre doigt, et la créature qui vous a infligé des dégâts est momentanément entourée de flammes infernales. La créature doit effectuer un jet de sauvegarde de Dextérité. Elle subit 2d10 dégâts de feu en cas d'échec, ou la moitié de ces dégâts en cas de réussite. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, les dégâts sont augmentés de 1d10 pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
    ...
    {
        "title": "Sanctuaire privé de Mordenkainen",
        "level": "niveau 4",
        "school": "abjuration",
        "incantation": "niveau 4 - abjuration",
        "portee": "36 mètres",
    ...
    },
    {
        ...
        "incantation": "niveau 5 - divination",
        "portee": "personnelle",
        "composantes": "V, S, M (un focaliseur d'une valeur minimum de 1 000 po, comme une boule   de cristal, un miroir en argent, ou une vasque remplie d'eau bénite) ",
        "duree": "concentration, jusqu'à 10 minutes",
    ...
    },
    {
        ...
        "level": "niveau 6",
        "school": "divination",
        "incantation": "niveau 6 - divination",
        "portee": "personnelle",
    ...
    },
    {
        ...
        "duree": "1 heure",
        "description": "Vous vous protégez avec un semblant nécromantique de vie. Vous gagnez 1d4 + 4 points de vie temporaires pour la durée du sort. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 2 ou supérieur, vous gagnez 5 points de vie temporaires supplémentaires pour chaque niveau d'emplacement au-delà du niveau 1. <br>"
    },
    {
        "title": "Soins",
        "level": "niveau 1",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Un flot d'énergie curative émane d'un point de votre choix dans la portée du sort. Choisissez jusqu'à six créatures dans une sphère d'un rayon de 9 mètres centrée sur ce point. Chaque cible récupère un nombre de points de vie égal à 3d8 + le modificateur de votre caractéristique d'incantation. Ce sort n'a aucun effet sur les morts-vivants ou les créatures artificielles. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 6 ou supérieur, la quantité de points de vie récupérés est augmentée de 1d8 pour chaque niveau d'emplacement au-delà du niveau 5. <br>"
    },
    {
        "title": "Sommeil",
        "level": "niveau 1",
    ...
    },
    {
        ...
        "duree": "concentration, jusqu'à 1 minute",
        "description": "Une sphère de feu d'un diamètre de 1,50 mètre apparait dans un espace inoccupé de votre choix dans la portée et pour la durée du sort. Toute créature qui termine son tour à 1,50 mètre ou moins de la sphère doit réussir un jet de sauvegarde de Dextérité sans quoi elle subit 2d6 dégâts de feu. Si elle réussit, les dégâts sont réduits de moitié. <br>Avec une action bonus, vous pouvez déplacer la sphère jusqu'à 9 mètres. Si la sphère entre en collision avec une créature, celle-ci doit faire un jet de sauvegarde contre les dégâts de la sphère et elle arrête son mouvement pour ce tour. <br>Lorsque vous déplacez la sphère, vous pouvez la diriger par-dessus des barrières de 1,50 mètre ou moins et la propulser au-dessus d'un gouffre large de 3 mètres ou moins. La sphère enflamme les objets inflammables qui ne sont pas portés ou transportés, et émet une lumière vive dans un rayon de 6 mètres et une lumière faible sur 6 mètres supplémentaires. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 3 ou supérieur, les dégâts sont augmentés de 1d6 pour chaque niveau d'emplacement au-delà du niveau 2. <br>"
    },
    {
        "title": "Sphère glaciale d'Otiluke",
        "level": "niveau 6",
        "school": "évocation",
        "incantation": "niveau 6 - évocation",
        "portee": "90 mètres",
    ...
    },
    {
        ...
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Vous touchez une créature vivante qui est à 0 point de vie. La créature devient stable. Ce sort n'a aucun effet sur les morts-vivants ou les créatures artificielles. <br>"
    },
    {
        "title": "Suggestion",
        "level": "niveau 2",
    ...
    {
        "title": "Tentacules noirs d'Evard",
        "level": "niveau 4",
        "school": "invocation",
        "incantation": "niveau 4 - invocation",
        "portee": "27 mètres",
    ...
    },
    {
        ...
        "duree": "concentration, jusqu'à 2 heures",
    ...
    },
    {
        ...
        "level": "niveau 1",
        "school": "illusion (rituel)",
        "incantation": "niveau 1 - illusion (rituel)",
        "portee": "contact",
    ...
    {
        "title": "Transport par les plantes",
        "level": "niveau 6",
        "school": "invocation",
        "incantation": "niveau 6 - invocation",
        "portee": "3 mètres",
    ...
    },
    {
        ...
        "portee": "champ de vision",
        "composantes": "V, S",
        "duree": "concentration, jusqu'à 6 rounds",
    ...
    },
    {
        ...
        "composantes": "V",
        "duree": "instantanée",
        "description": "Vous frappez le sol, créant une onde d'énergie divine qui se propage à partir de vous. Chaque créature que vous choisissez, située à 9 mètres ou moins de vous, doit réussir un jet de sauvegarde de Constitution ou subir 5d6 dégâts de tonnerre, ainsi que 5d6 dégâts radiants ou nécrotiques (au choix) et être jetée à terre. Une créature qui réussit son jet de sauvegarde ne subit que la moitié de ces dégâts et ne tombe pas à terre. <br>"
    },
    {
        "title": "Vaporisation de poison",
        "level": "niveau 0",
        "school": "invocation",
        "incantation": "niveau 0 - invocation",
        "portee": "3 mètres",
        "composantes": "V, S",
        "duree": "instantanée",
        "description": "Vous tendez votre paume vers une créature visible dans la portée du sort et vous projetez une bouffée de gaz nocif de votre main. La créature doit réussir un jet de sauvegarde de Constitution sans quoi elle subit 1d12 dégâts de poison. <br>Les dégâts de ce sort augmentent de 1d12 lorsque vous atteignez le niveau 5 (2d12), le niveau 11 (3d12) et le niveau 17 (4d12). <br>"
    },
    {
        ...
        "duree": "jusqu'à dissipation",
        "description": "Vous touchez un objet fermé comme une porte, une fenêtre, un portail ou un coffre, et celui-ci se retrouve verrouillé pour la durée du sort. Vous et les créatures que vous désignez lors du lancement du sort pouvez ouvrir l'objet normalement. Vous pouvez aussi créer un mot de passe qui, quand il est prononcé à 1,50 mètre ou moins de l'objet, supprime l'effet du sort pendant 1 minute. Autrement, il est impossible de passer l'objet, sauf s'il est brisé ou si le sort est dissipé ou prend fin. Lancer le sort <em><a href=\"#deblocage\">déblocage</a></em> supprime <em>verrou   magique</em> pendant 10 minutes. <br>L'objet affecté par le sort est plus difficile à briser ou forcer ; le DD pour le briser ou tenter de le crocheter augmente de 10. <br>"
    },
    {
    ...
    },
    {
        ...
        "duree": "concentration, jusqu'à 10 minutes",
        "description": "Vous touchez une créature consentante. La cible obtient une vitesse de vol de 18 mètres pour la durée du sort. Lorsque le sort prend fin, la cible tombe si elle est toujours dans les airs, sauf si elle peut empêcher la chute. <br><strong><em>Aux niveaux supérieurs</em></strong>. Lorsque vous lancez ce sort en utilisant un emplacement de sort de niveau 4 ou supérieur, vous pouvez cibler une créature additionnelle pour chaque niveau d'emplacement au-delà du niveau 3. <br>"
    },
    {
        ...
        "composantes": "V, S",
        "duree": "10 minutes",
        "description": "Vous créez une zone magique qui protège de la tromperie dans une sphère de 4,50 mètres de rayon centrée sur un point de votre choix à portée. Jusqu'à la dissipation du sort, une créature qui pénètre dans la zone du sort pour la première fois lors d'un tour ou qui y débute son tour, doit réussir un jet de sauvegarde de Charisme. Sur un échec, une créature ne peut pas délibérément dire un mensonge tant qu'elle se trouve dans la zone. Vous savez par ailleurs si une créature a réussi ou non son jet de sauvegarde. <br>Une créature affectée est consciente du sort et peut ainsi éviter de répondre à des questions auxquelles elle aurait normalement répondu par un mensonge. Une telle créature peut rester évasive dans ses réponses tant qu'elles restent dans les limites de la vérité. <br>"
    }
]
